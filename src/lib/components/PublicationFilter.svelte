<script lang="ts">
	...
	// State for filters - synced from props
	...
	function updateFilters(publisher: string, year: string) {
								...
								<Command.Group>
									...
									{#each publishers() as publisher}
										<Command.Item
											value={publisher}
											onSelect={() => {
												updateFilters(publisher, selectedYear);
												closePublisherAndFocus();
											}}
										>
											<CheckIcon
							...
							<Command.List>
								...
								<Command.Group>
									<Command.Item
										value=""
										onSelect={() => {
											updateFilters(selectedPublisher, "");
											closeYearAndFocus();
										}}
									>
										<CheckIcon
									...
									{#each years() as year}
										<Command.Item
											value={year}
											onSelect={() => {
												updateFilters(selectedPublisher, year);
												closeYearAndFocus();
											}}
										>
											<CheckIcon
